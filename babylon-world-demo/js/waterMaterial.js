(function () {
  ...
  WaterMaterial = function (name, scene, light) {
    ...
    this.bumpTexture = new BABYLON.Texture("./images/bump.png", scene);
  ...
  // Not required - just a helper method
  WaterMaterial.prototype.getRenderTargetTextures = function () {
    return [this.reflectionTexture, this.refractionTexture];
  };

  // Babylon.js will call this function to know if the material is ready to be used
  WaterMaterial.prototype.isReady = function (mesh) {
    ...
    this._effect = engine.createEffect("./flux/water",
      ["position", "normal", "uv"],
  ...
  // Babylon.js will call this function to activate the shader before rendering objects that use it
  ...
  // Releases resources created for the material
